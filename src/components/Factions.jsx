...
const Factions = (props) => {
  ...
  return (
    <div className="md:p-4">
      <h1 className = "font-bold uppercase p-4 text-4xl md:text-5xl text-black dark:text-white">Factions</h1>
      {/* PC */}
      <div className = "max-lg:hidden flex justify-center items-center">
        ...
        <div className="grid">
          ...
          <div className="flex h-32">
            <div className={props.cardColor + " block max-w-xs p-5 bg-white border border-gray-200 rounded-lg shadow dark:border-gray-700"}>
      ...
      {/* Mobile */}
      <div className = {props.cardColor + " lg:hidden text-left py-2 justify-center items-center mx-auto bg-slate-200 dark:bg-slate-800 rounded-lg" }>
        <table class="border-separate border border-slate-900 dark:border-slate-500 w-full border-spacing-2 text-black dark:text-white">
          <tbody>
            <tr>
              <td class="border border-slate-700 p-2"><h2 className="md:text-2xl text-end">Weapon</h2></td>
              <td class="border border-slate-700 p-2"><img src={weaponIcon}/></td>
            </tr>
            <tr>
              <td class="border border-slate-700 p-2"><h2 className="md:text-2xl text-end">Vision</h2></td>
              <td class="border border-slate-700 p-2"><img className="" src = {'https://genshin.jmp.blue/elements/' + props.vision.toLowerCase() + '/icon'} /></td>
            </tr>
            <tr>
              <td class="border border-slate-700 p-2"><h2 className="md:text-2xl text-end">Rarity</h2></td>
              <td class="border border-slate-700 p-2"><div className="inline-flex">{convertRarity()}</div></td>
            </tr>
            <tr>
              <td class="border border-slate-700 p-2"><h2 className="md:text-2xl text-end">Affiliation</h2></td>
              <td class="border border-slate-700 p-2"><p className="font-normal text-gray-700 dark:text-gray-400">{props.affiliation}</p></td>
            </tr>
            <tr>
              <td class="border border-slate-700 p-2"><h2 className="md:text-2xl text-end">Birthday</h2></td>
              <td class="border border-slate-700 p-2"><p className="font-normal text-gray-700 dark:text-gray-400">{props.birthday}</p></td>
            </tr>
            <tr>
              <td class="border border-slate-700 p-2"><h2 className="md:text-2xl text-end">Release Date</h2></td>
              <td class="border border-slate-700 p-2"><p className="font-normal text-gray-700 dark:text-gray-400">{props.releaseDate}</p></td>
            </tr>
            <tr>
              <td class="border border-slate-700 p-2"><h2 className="md:text-2xl text-end">Gender</h2></td>
              <td class="border border-slate-700 p-2"><p className="font-normal text-gray-700 dark:text-gray-400">{props.gender}</p></td>
            </tr>
            <tr>
              <td class="border border-slate-700 p-2"><h2 className="md:text-2xl text-end">Nation</h2></td>
              <td class="border border-slate-700 p-2"><p className="font-normal text-gray-700 dark:text-gray-400">{props.nation}</p></td>
            </tr>
          </tbody>
        </table>
      </div>
