              ...
              <div className = "w-full py-2">
                <div className= {props.cardColor + " p-5 lg:flex w-full items-center border border-gray-800 dark:border-gray-200 rounded-3xl shadow"}>
                  <div className="text-start lg:w-1/2 lg:p-5 ">
                    ...
                    <div className="inline-flex justify-between max-md:pt-5 md:p-5 ">                      
                      <img className="pr-5 rounded-t-lg lg:rounded-none lg:rounded-s-lg size-28 md:size-auto flex justify-center my-auto object-contain" src={reorderedImages[idx]} alt=""/>
                  ...
                  <div className= "lg:w-1/2">
                    <div className="lg:flex lg:flex-col">
                      {idx == 0 && props.charPreviewData.skillTalents[0].upgrades && chart ?
                      <div className="">
                        <RadarChart
                          chart = {chart}
                          showChart = {showChart}
