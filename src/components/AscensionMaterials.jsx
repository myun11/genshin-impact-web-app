...
const AscensionMaterials = (props) => {
    ...
    return (
        <div className="md:p-4">
            <h1 className = "uppercase font-bold p-4 text-4xl md:text-5xl text-black dark:text-white text-left lg:text-center">Ascension Materials</h1>
            <div className="md:flex">
                ...
                {/* Body */}
                <div className= {props.cardColor + "p-4 text-medium border border-black dark:border-white text-black dark:text-gray-200 rounded-lg w-full"}>
                    {selectedTab == "Total" ?  
