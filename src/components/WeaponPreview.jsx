...
const WeaponPreview = (props) => {
    ...
    return (
        <div className = "lg:w-4/5 flex-auto justify-center items-center mb-4 mx-auto">
            ...
            <button className={"group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-full px-6 text-black dark:text-white border border-black dark:border-white"} onClick = {() => {
